...
<div class="card o-hidden border-0 shadow-lg my-5">
    <div class="card-body p-0">
        ...
        <div class="row">
            ...
            <img src="<?php echo base_url('assets/img/1.jpg') ?>" alt="" width="500px" height="610px">
            </div>
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" action="<?php echo site_url('user_controller/inscription') ?>" method="post">
                    ...
                    <div class="text-center">
                        <a class="small" href="<?php echo site_url('login_controller/login')?>">Already have an account? Login!</a>
                    </div>
                </div>
            </div>
        </div>
